...
ggplot(merged_dataset, aes(x = percentage_ReligionByCountry_TotalReligious_2020)) + 
  geom_histogram(bins = 20, fill = "lightblue", color = "black") +
...
qqnorm(merged_dataset$percentage_ReligionByCountry_TotalReligious_2020)
qqline(merged_dataset$percentage_ReligionByCountry_TotalReligious_2020, col = "red")
